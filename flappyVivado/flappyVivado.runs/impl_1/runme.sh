...
HD_PWD='C:/Users/aabua/Documents/ECE350/flappyECE350/flappyVivado/flappyVivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flappy_Wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flappy_Wrapper.tcl -notrace
